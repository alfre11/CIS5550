...
public class HW6Test extends GenericTest {
  ...
  void runTests(Set<String> tests) throws Exception {
    ...
    if (tests.contains("wordcount")) try {
        startTest("wordcount", "wordcount", 10);
        try {
        	String[] arg = {"apple banana coconut banana banana apple coconut"};
	        String argsAsString = "apple banana coconut banana banana apple coconut";
	
	        String expected = "banana: 3\napple: 2\ncoconut: 2";
