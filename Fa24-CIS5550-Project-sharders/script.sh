...
flameWorkers=30 # number of flame workers to launch
...
javac -cp lib/kvs.jar:lib/webserver.jar:lib/flame.jar -d bin --source-path src src/cis5550/jobs/Ranker.java
sleep 1
jar cf ranker.jar bin/cis5550/jobs/Ranker.class
sleep 1
