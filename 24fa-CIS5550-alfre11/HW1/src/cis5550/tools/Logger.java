...
public class Logger {
  ...
  public void info(String message) {
	//System.out.println("PLEASE FUCKIGN WORK"); 
  ...
  public static Logger getLogger(Class c) {
	//System.out.println("getLoggerCalled");
    if (prefixToLogger == null) {
    	defaultLogger = new Logger(ALL);
      logfile = null;
    	...
    	try {
          ...
          if (pcs[0].equals("log")) {
            ...
            String logfileName = pcs[1].replaceAll("\\$MAINCLASS", getMainClassName()).replaceAll("\\$PID", ""+ProcessHandle.current().pid());
              ...
              System.out.println("LOG FILE MADE"); 
            } catch (Exception e) {
    	  ...
    	  try { r.close(); } catch (IOException ioe) {}
    		...
    		System.out.println("little bro has logging disabled");
    	}
    }
